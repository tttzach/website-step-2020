...
public final class FindMeetingQuery {
  ...
  public Collection<TimeRange> query(Collection<Event> events, MeetingRequest request) {
    ...
    // Consolidate all time ranges of events that involve any of the proposed meeting attendees
    ...
    // Sort previously consolidated time ranges by start time of event
    ...
    // Get all available time slots that meet the duration criterion
