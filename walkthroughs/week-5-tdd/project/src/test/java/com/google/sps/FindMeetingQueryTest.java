...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeAllDay() {
    // Have each person have different events. We should see three options because each person has
    // split the restricted times and optional attendee with all-day event should be ignored.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeIsConsidered() {
    ...
    // split the restricted times and optional attendee is treated as a mandatory attendee.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void optionalJustEnoughRoom() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting.The optional attendee should be ignored since considering their schedule 
  ...
  @Test
  public void freeMandatoryAttendeesButBusyOptionalAttendees() {
    // Some mandatory attendees with no events the whole day, one optional attendee with a gap in their schedule.
    ...
    Collection<TimeRange> actual = query.query(events, request);
    Collection<TimeRange> expected = Arrays.asList(TimeRange.fromStartEnd(TIME_0900AM, TIME_1100AM, false));

    Assert.assertEquals(expected, actual);
  }

  @Test
  public void freeMandatoryAttendeesButVeryBusyOptionalAttendees() {
    // Some mandatory attendees with no events the whole day, one optional attendee with no gaps in their schedule.
    // The optional attendee should not be considered.
    //
    // Events  : |----------C----------|
    // Day     : |---------------------|
    // Options : |---------------------|
